            ...
            <form onSubmit={handleUserDeletion} >
                {deleting === false && (
                    <button
                        ...
                        value={id}
                        type="submit"
                        className="btn-xs flex justify-start items-center gap-1 bg-red-700 text-white rounded-full font-sans font-semibold text-xs px-2 py-0.5 transition-all cursor-pointer">
