    ...
    return (<>
        ...
        <dialog id="addstation_modal" className="modal">
            <div className="modal-box w-80 bg-zinc-50">
                ...
                <div className="mb-5">
                    <h1 className="text-xl text-black font-notosans font-bold leading-none">Add New Station</h1>
                    <span className="label-text text-xs text-zinc-800">Fill out the form and add Station.</span>
                </div>
